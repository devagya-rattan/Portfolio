...
const ProjectsData = [
  ...
  },
  {
    ...
    description: `This article, likely from a Hindi-language newspaper, discusses the importance of planting and preserving trees, especially in light of decreasing oxygen levels and increasing carbon dioxide in the atmosphere.  With World Earth Day approaching on April 22nd, experts are emphasizing the urgency of environmental conservation.  The article highlights the current oxygen crisis due to the COVID-19 pandemic and warns of a future where natural oxygen becomes scarce if tree planting is neglected.  Navneet Shukla, who conducts large-scale tree planting in Bareilly, stresses that planting is only the first step; protecting those trees is even more crucial.  He notes that many people plant trees but forget to water them, leading to their demise.  The article also mentions the alarming statistic of a 2.6 million ton decrease in oxygen and a 2.4 million ton increase in carbon dioxide in recent years.  It underscores the significance of World Earth Day in raising awareness about environmental issues and encourages everyone to plant at least one tree and take responsibility for its growth.  The image accompanying the article shows Navneet Shukla, a local figure actively involved in tree plantation efforts.`,
    image: Image9,
  },
  {
  ...
  {
    title: "Radio City Appreciation: Shaan Honored",
  ...
  {
    title: "Validating Startup Ideas: Online Lecture by Navnit Shukla",
  ...
  {
    title: "Governance Shaala: Netratva Shaala",
